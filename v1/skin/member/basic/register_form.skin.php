...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
		    <th scope="row"><label for="reg_mb_1">기수<strong class="sound_only">필수</strong></label></th>
			<td>
			    <input type="text" name="mb_1" value="<?php echo isset($member['mb_1'])?$member['mb_1']:'';?>" required class="frm_input required nospace" size="10" maxlength="2">숫자만 입력해 주세요
			</td>
		</tr>
        <?php if ($req_nick) {  ?>
        <tr style="display:none;">
            ...
            <td>
                ...
                <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?$member['mb_nick']:''; ?>" id="reg_mb_nick" class="frm_input nospace" size="10" maxlength="20">
